...
class GaborFilter
{
	...
	*/
    public: int kernel_size; ///size of filter's kernel
	
	public: double sigma; ///parameter sigma (see Gabor Filter definition)
	public: double theta; ///parameter theta - ridge orientation
	public: double lm;	  ///parameter lambda - distance between two valleys 
	public: double gm;	  ///parameter gamma (see Gabor Filter definition)
	public: double psi;	  ///parameter psi (in this implementation should be 0)
